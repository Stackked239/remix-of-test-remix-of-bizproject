...
export async function buildLilManagerFinancialsReport(
  ...
  const report: LILGeneratedReport = {
    ...
    sections: ['Title & Introduction', 'Executive Summary', 'Financial Health Snapshot', 'Priority Action', 'Priority Focus Areas', 'Gap to Excellence', 'Deep Dive: Financial Dimensions', 'Quick Wins', 'Financial Action Plan', 'Essential Tools & Templates', 'Financial Metrics & 90-Day Targets', 'Progress Tracker', 'Next Steps'],
