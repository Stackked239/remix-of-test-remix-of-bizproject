...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .action-item { display: grid; grid-template-columns: 24px 1fr auto auto; gap: 12px; align-items: start; padding: 10px 0; border-bottom: 1px solid #f0f0f0; font-size: 0.95rem; }
    .action-item:last-child { border-bottom: none; }
    .action-checkbox { width: 20px; height: 20px; border: 2px solid var(--border-color); border-radius: 4px; margin-top: 2px; }
    .action-time { font-size: 0.8rem; color: var(--text-secondary); white-space: nowrap; }
    .action-impact { font-size: 0.8rem; color: var(--proficiency); font-weight: 500; white-space: nowrap; }
