            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-background/80">support@businesshealthanalyzer.com</span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="w-5 h-5" />
                  <span className="text-background/80">1-800-ANALYZE (1-800-262-5993)</span>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="text-background/80 space-y-1">
                ...
                <div className="text-sm mt-2">*Reports are generated instantly 24/7</div>
              </div>
            </div>
          </div>
        </div>
