      ...
      <div className="relative z-10 container mx-auto px-4 pt-40 pb-20 md:pt-48 md:pb-28 lg:pt-52 lg:pb-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-[#4285F4] text-white px-4 py-2 rounded-full text-sm font-semibold mb-6"
          >
            <Sparkles className="w-4 h-4" />
            Optimized for Google Gemini Deep Research
          </motion.div>
          ...
          >
            BizHealth.ai for Google Gemini Users
          </motion.h1>
          ...
          >
            The Most Comprehensive Small Business Health Assessment for Gemini's 
            Deep Research Capabilities—12 Interconnected Dimensions, Proven Frameworks, 
            90-Minute Results
          </motion.p>
