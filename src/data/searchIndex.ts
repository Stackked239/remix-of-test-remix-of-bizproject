...
export const searchablePages: SearchableItem[] = [
  ...
  },
  {
    ...
    keywords: "P3 placement planogram, retail curriculum, store layout strategy, product placement training, planogram course, visual merchandising training, retail education, BizGrowth Academy, 6 P's retail, specialty retail training, boutique business education, retail sales optimization, shelf placement strategy, store zones, traffic patterns, eye level placement, cross-merchandising tactics, seasonal reset planning, retail DIY planogram, sales per square foot, zone performance, retail metrics training, physical store layout, retail transformation, boutique owner education, gift shop training, specialty retailer course, placement framework, 30-day pilot planogram, retail operations training, store design course, product adjacency strategy, retail staff training, planogram implementation",
    icon: GraduationCap
  }
];
