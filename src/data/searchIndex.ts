...
export const searchableCurriculum: SearchableItem[] = [
  ...
  {
    type: "Curriculum",
    title: "Module 1: Why Customer Feedback Matters - Customer Feedback Curriculum",
    excerpt: "Learn why customer feedback is your #1 competitive advantage. Discover the business case for listening to customers, 41% revenue uplift stats, and complete a self-assessment quiz to understand where you stand.",
    url: "/bizgrowth/voc/why-it-matters",
    keywords: "why customer feedback matters, customer feedback business case, customer feedback ROI, customer feedback benefits, customer feedback importance, customer feedback competitive advantage, customer feedback self assessment, customer feedback quiz, 41% revenue uplift, customer retention savings, customer feedback system benefits, flying blind, customer listening system, four step cycle, listen analyze act monitor, customer perception gap, customer feedback training module, bizgrowth academy, customer feedback learning, small business customer feedback, feedback importance, why listen to customers, customer insight value, segment selector, business stage assessment, launch growth scaling enterprise",
    icon: GraduationCap
  },
  {
    type: "Curriculum",
    title: "Module 2: The Four Core Components - Customer Feedback Curriculum",
    excerpt: "Master the 4 essential feedback components: active + passive feedback collection, omnichannel listening, closing the loop, and centralized data management. Free feedback tracker template included.",
    url: "/bizgrowth/voc/core-components",
    keywords: "core components, four components, active feedback, passive feedback, omnichannel listening, closing the loop, centralized data, feedback tracker, feedback collection methods, customer surveys, review monitoring, social listening, support tickets, feedback channels, response loop, customer follow-up, feedback data management, system components, training module 2, bizgrowth academy, feedback tracker template, free feedback tracker, NPS survey, CSAT survey, post-purchase survey, review collection, Google reviews, feedback consolidation, customer data hub, architecture, building blocks, framework, system design, multi-channel feedback, customer touchpoints, feedback sources, best practices, SMB feedback system, small business feedback system, how to collect feedback, feedback collection guide",
    icon: GraduationCap
  },
  {
    type: "Curriculum",
    title: "Module 3: Measuring What Matters - Customer Feedback Curriculum",
    ...
    keywords: "customer metrics, measuring customer satisfaction, NPS, net promoter score, CSAT, customer satisfaction score, CES, customer effort score, sentiment analysis, NPS calculator, satisfaction metrics, customer feedback metrics, survey metrics, loyalty metrics, customer loyalty score, promoters detractors passives, NPS survey, CSAT survey, CES survey, sentiment tracking, feedback measurement, customer analytics, measure customer experience, track customer satisfaction, customer score, NPS benchmark, CSAT benchmark, customer feedback KPIs, satisfaction KPIs, loyalty measurement, retention metrics, churn prediction, customer health score, feedback analytics, dashboard, metrics template, survey template, NPS template, CSAT template, training module 3, bizgrowth academy, customer metrics guide, how to measure satisfaction, which metric to use, choosing customer metrics, 7 day quick start, metric trends, trend analysis",
    icon: GraduationCap
  },
  {
    type: "Curriculum",
    title: "Module 4: Closing the Loop - Customer Feedback Curriculum",
    ...
    keywords: "closing the loop, customer feedback response, feedback loop, closed-loop process, customer recovery, detractor outreach, feedback acknowledgment, customer loyalty, follow-up, feedback response templates, email templates, customer response, loop closure, feedback system, best practices, customer advocacy, promoter conversion, feedback management, response time, 48 hour response, customer retention, feedback acknowledgment email, detractor recovery, you asked we delivered, honest no response, customer communication, feedback ownership, training module 4, bizgrowth academy, how to respond to feedback, customer complaint response, negative review response, turning complaints into loyalty",
    icon: GraduationCap
  },
  {
    type: "Curriculum",
    title: "Module 5: Your 7-Day Quick Start - Customer Feedback Curriculum",
    excerpt: "Transform from learner to implementer with a realistic 7-day customer feedback action plan. Collect real feedback, find patterns, and make ONE visible improvement this week with interactive day-by-day progress tracking.",
    url: "/bizgrowth/voc/7-day-quickstart",
    keywords: "7 day plan, quick start, customer feedback implementation, action plan, survey templates, feedback tracker, closing the loop, customer insights implementation, week one, first survey, launch, start program, implement customer feedback, collect feedback, analyze feedback, act on feedback, feedback patterns, customer themes, quick win, momentum, day by day plan, checklist, tracker, bizgrowth academy, how to start, for beginners, practical, implementation guide, 7 day challenge, weekly plan, kickoff, feedback collection day, insight analysis, customer insight action, first improvement",
    icon: GraduationCap
  },
  {
    type: "Curriculum",
    title: "Module 6: Building Your 90-Day System - Customer Feedback Curriculum",
    excerpt: "Transform the 7-day quick start into a sustainable 90-day customer feedback system. Build team accountability, operational rhythms, and organizational capability with RACI matrices, weekly/monthly checkpoints, and downloadable implementation guides.",
    url: "/bizgrowth/voc/90-day-system",
    keywords: "90 day system, sustainable, implementation, team, organizational, ownership, RACI matrix, accountability, weekly rhythm, monthly review, quarterly planning, team training, delegation, scale, at scale, operations, process, playbook, 12 week plan, foundation weeks, refinement weeks, optimization weeks, KPIs, metrics, dashboard, reporting, pitfalls, common mistakes, best practices, system design, framework, long-term, enterprise, maturity, culture, customer-centric culture, feedback culture, training module 6, bizgrowth academy, how to build system, for teams, organization, systematic feedback, operational excellence, calendar, templates, implementation guide",
    icon: GraduationCap
  },
  {
    type: "Curriculum",
    title: "Module 7: Advanced Techniques - Customer Feedback Curriculum",
    excerpt: "Master advanced customer feedback techniques: 5 Whys root cause analysis, customer segmentation strategy, building customer-centric culture, feedback dashboard setup, and maturity benchmarking. Gated graduation module with certificate and reference guide.",
    url: "/bizgrowth/voc/advanced",
    keywords: "advanced techniques, root cause analysis, 5 whys, five whys, customer segmentation, segmentation, customer personas, customer-centric culture, culture, feedback dashboard, maturity, maturity assessment, benchmarking, certification, certificate, graduation, capstone, advanced customer feedback, enterprise, mastery, practitioner, theme analysis, feedback analysis, pattern recognition, customer cohorts, buyer personas, cultural transformation, customer obsession, metrics, KPIs, executive, leadership, governance, training module 7, bizgrowth academy, final module, complete curriculum, reference guide, downloadable resources, gated content, unlock advanced, completion, program completion",
    icon: GraduationCap
  }
];
