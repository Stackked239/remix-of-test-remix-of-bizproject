...
const BizGuides = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="BizGuides Archive - Personalized Business Coaching & Guidance"
        description="Archived version of the BizGuides landing page. Visit bizhealth.ai/bizguides for the latest."
        ...
        canonical="https://bizhealth.ai/bizguides-archive"
        ogImage="/og-images/og-bizguides.jpg"
        noindex={true}
      />
      <StructuredData 
        type="service"
        name="BizGuides Archive - Business Coaching"
        description="Archived version of the personalized business coaching page"
        provider="BizHealth.ai"
        areaServed="United States"
        url="https://bizhealth.ai/bizguides-archive"
      />
      <PromotionalBanner />
