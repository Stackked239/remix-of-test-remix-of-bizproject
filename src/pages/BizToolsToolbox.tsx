        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <div className="text-center space-y-6">
            ...
            <h1 className="font-montserrat font-bold text-4xl md:text-5xl lg:text-6xl text-white leading-tight">
              Welcome to Your BizTools Toolbox—
              <span className="text-biz-green block mt-2">Where Insights Become Action.</span>
            </h1>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {category.tools.map((tool, toolIndex) => (
                        <div 
                          key={toolIndex} 
                          className="flex items-center justify-between p-3 rounded-lg transition-all duration-300 hover:bg-biz-lime/10 hover:translate-x-1 cursor-pointer group border border-transparent hover:border-biz-lime/20"
                        >
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-open-sans">50+ free templates & tools</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle className="w-5 h-5 text-biz-green flex-shrink-0" />
                      <span className="font-open-sans">Basic frameworks & checklists</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle className="w-5 h-5 text-biz-green flex-shrink-0" />
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-open-sans">500+ premium resources</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle className="w-5 h-5 text-biz-copper flex-shrink-0" />
                      <span className="font-open-sans">Advanced frameworks & ROI calculators</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle className="w-5 h-5 text-biz-copper flex-shrink-0" />
                    ...
                    <div className="flex items-center gap-3">
                      <CheckCircle className="w-5 h-5 text-biz-copper flex-shrink-0" />
                      <span className="font-open-sans font-bold">Avg. 27x ROI within 6 months</span>
                    </div>
