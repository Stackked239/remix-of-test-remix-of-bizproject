...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-biz-navy to-biz-grey">
      <SEO
        title="Sign In | BizHealth.ai"
        description="Sign in to your BizHealth.ai account to access your business health assessment reports and client portal."
        canonical="https://bizhealth.ai/login"
        noindex={true}
      />
      <PromotionalBanner />
      <GlobalNavigation />
      
      <main className="flex-1 flex items-center justify-center px-4 py-12 pt-40">
        <div className="w-full max-w-md">
          <Card className="shadow-elegant border-border/50">
            ...
            <CardContent className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between text-sm">
                  <Link 
                    to="/forgot-password" 
                    className="font-open-sans text-biz-navy hover:text-biz-green transition-colors"
                  >
                    Forgot password?
                  </Link>
                </div>
            ...
            <CardFooter className="flex flex-col space-y-4">
              <div className="text-center text-sm font-open-sans text-biz-grey">
              ...
              <div className="text-center text-xs font-open-sans text-biz-grey">
