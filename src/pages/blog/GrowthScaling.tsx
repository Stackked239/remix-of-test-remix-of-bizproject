...
// Subcategory mapping for Growth & Scaling posts
const subcategoryMap: Record<string, string> = {
  'renewal-imperative-legacy-business-rebirth': 'Business Transformation',
  'customer-acquisition-cost-guide-smb': 'Unit Economics',
  'growth-ceiling-gut-instinct-scaling': 'Scaling Challenges',
  'growth-trap-or-growth-engine': 'Growth Readiness',
  'chaos-to-clarity-operating-rhythm-scaling-teams': 'Scaling Operations',
  'scaling-operations-without-losing-control': 'Scaling Operations',
  'e-commerce-scaling-5-strategies-for-smbs-thriving-in-2025': 'E-Commerce Growth',
  'smb-scaling-paradox-2025': 'Scaling Challenges',
  'growth-trap-broken-business-model': 'Business Model',
  'happy-new-year-2026-year-of-growth': 'Growth Strategy',
  'secret-weapon-why-process-matters': 'Scaling Operations'
};
...
const GrowthScaling = () => {
  ...
  const blogPosts = useMemo(() => 
    getPostsByCategoryWithSubcategories('Growth & Scaling', subcategoryMap, 'Growth Strategy'),
    []
  );
      ...
      <section className="py-16 px-6 bg-[#faf9f7]">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-[#7C7C7C] mb-8 max-w-2xl mx-auto">
            Get expert insights on sustainable growth strategies, scaling frameworks, and business expansion delivered to your inbox.
          </p>
