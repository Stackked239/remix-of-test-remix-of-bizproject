...
// Subcategory mapping for Technology posts
const subcategoryMap: Record<string, string> = {
  'renewal-imperative-legacy-business-rebirth': 'Digital Transformation',
  'planograms-transform-small-retail-operations': 'Business Intelligence',
  'leading-blind-business-intelligence-small-business': 'Business Intelligence',
  'customer-acquisition-cost-guide-smb': 'Business Intelligence',
  'growth-ceiling-gut-instinct-scaling': 'Business Intelligence',
  'scheduling-crisis-operational-costs': 'Automation',
  'estimating-crisis-service-business-profitability': 'Digital Tools',
  'crm-reality-check-small-business-decision': 'Software Selection',
  'technology-strategic-ally-roi-decisions': 'Software Selection',
  'business-health-scores-by-stage': 'Business Intelligence',
  'technology-innovation-gap-competitive-advantage': 'Digital Transformation',
  'overcoming-bi-challenges-smb': 'Business Intelligence',
  'hidden-costs-manual-processes': 'Automation',
  'scaling-operations-without-losing-control': 'Business Intelligence',
  'success-begins-with-2026-strategy': 'Business Intelligence',
  'confirm-business-weaknesses-without-consultants': 'AI & Machine Learning',
  'small-business-ai-adoption': 'AI & Machine Learning',
  'small-business-blind-spots-2025': 'Business Intelligence',
  'real-time-analytics-smb-agility': 'Business Intelligence',
  'ai-business-analytics': 'AI & Machine Learning',
  'retail-remote-tools': 'Digital Tools',
  'chasing-sales-not-profits': 'Business Intelligence',
  'grow-your-business-with-ai': 'AI & Machine Learning'
};
...
const Technology = () => {
  ...
  const blogPosts = useMemo(() => 
    getPostsByCategoryWithSubcategories('Technology', subcategoryMap, 'Digital Transformation'),
    []
  );
    ...
    <div className="min-h-screen bg-[#faf9f7]">
      ...
      >
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            Navigate the digital landscape with confidence. Expert guidance on business intelligence, 
            AI adoption, automation, and making technology decisions that drive real growth.
          </p>
      ...
      <section className="py-16 px-6 bg-[#faf9f7]">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-[#7C7C7C] mb-8 max-w-2xl mx-auto">
            Get expert insights on business technology, AI adoption, and digital transformation delivered to your inbox.
          </p>
