...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'BizHealth.ai',
        short_name: 'BizHealth.ai',
        description: 'AI-powered business health assessments and growth tools',
        theme_color: '#ffffff',
      ...
      workbox: {
        maximumFileSizeToCacheInBytes: 5 * 1024 * 1024, // 5 MiB - allows larger assets
